...
<head>
  ...
  <title>Warung Tekwan Model — Kasir</title>
  <meta name="description" content="POS Warung Tekwan Model — Kasir" />
  ...
  <div class="app" id="app">
    <aside class="sidebar">
      ...
      <nav class="nav" id="nav">
        ...
        <a href="kasir.php" data-route="kasir" class="active"><svg class="icon" viewBox="0 0 24 24" fill="none"><path d="M7 4h10l1 5H6L7 4zM6 10h12v9H6v-9z" fill="#fff"/></svg> Kasir</a>
